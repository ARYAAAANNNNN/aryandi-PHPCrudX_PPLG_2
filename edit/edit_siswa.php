        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="../process/update_siswa.php">
                    ...
                    <div class="row mb-3">
                        ...
                        <select class="form-control" name="id_kelas">
                            ...
                            ?>
                            <option value="<?php echo $k['id_kelas']; ?>" <?php if($d['id_kelas'] == $k['id_kelas']) echo 'selected'; ?>><?php echo $k['nama_kelas']; ?></option>
                            <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <select class="form-control" name="id_jurusan" required>
                            ...
                            ?>
                            <option value="<?php echo $j['id_jurusan']; ?>" <?php if($d['id_jurusan'] == $j['id_jurusan']) echo 'selected'; ?>><?php echo $j['nama_jurusan']; ?></option>
                            <?php
                            }
                            ?>
                        </select>
                    ...
                    <a href="../pages/siswa.php" class="btn btn-secondary">Batal</a>
                    </form>
