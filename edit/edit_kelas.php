        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="../process/update_kelas.php">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputEmail3" name="wali_kelas" value="<?php echo $d['wali_kelas']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Jumlah Siswa</label>
                        <div class="col-sm-10">
                        <input type="number" class="form-control" id="inputEmail3" name="jumlah_siswa" value="<?php echo $d['jumlah_siswa']; ?>">
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary">Update</button>
                    <a href="../pages/kelas.php" class="btn btn-secondary">Batal</a>
                    </form>
