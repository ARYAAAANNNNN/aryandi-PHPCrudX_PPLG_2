...
$data = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE id_jurusan = '$id_jurusan'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="../process/update_jurusan.php">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputEmail3" name="id_jurusan_display" value="<?php echo $d['id_jurusan']; ?>" disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Nama Jurusan</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPassword3" name="nama_jurusan" value="<?php echo $d['nama_jurusan']; ?>">
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary">Update</button>
                    <a href="../pages/jurusan.php" class="btn btn-secondary">Batal</a>
                    </form>
